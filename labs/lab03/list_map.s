...
main:   
    ...
    la a1, square  # load the address of the function in question into $a1
...
map:
    ...
    jalr ra s1 0  # Call the function in question on that value.
    
    sw a0, 0(s0)  # store the returned value back into the node
